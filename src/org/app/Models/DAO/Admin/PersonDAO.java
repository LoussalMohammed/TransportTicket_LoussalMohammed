...
public class PersonDAO {
    ...
    public void delete(int id) throws SQLException {
        String sql = "UPDATE ONLY persons SET deleted_at = ? WHERE id = ?";
    ...
    public void restore(int id) throws SQLException {
        String sql = "UPDATE ONLY persons SET deleted_at = ? WHERE id = ? AND role";
        try (Connection connection = databaseC.getInstance().getConnection();
             PreparedStatement statement = connection.prepareStatement(sql)) {
    ...
    public Person findById(int id) throws SQLException {
        try (Connection connection = databaseC.getInstance().getConnection()) {
            String sql = "SELECT * FROM ONLY persons WHERE id = ? AND deleted_at IS NULL";
            PreparedStatement statement = connection.prepareStatement(sql);
    ...
    public ArrayList<Person> getAllPersons() throws SQLException {
        ...
        try (Connection connection = databaseC.getInstance().getConnection()) {
            String sql = "SELECT * FROM ONLY persons WHERE deleted_at IS NULL";
